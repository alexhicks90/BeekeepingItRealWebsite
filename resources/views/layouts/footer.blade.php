...
<div class="container text-center">
  <div class="row">
    <!-- <div class="col-2 col-sm-6 col-md-8 col-lg-10"></div>
    <a class="col-5 col-md-2 col-lg-1 col-sm-3" href="https://www.facebook.com/BeekeepingItReal/"><img src="/images/fb-icon.svg" alt="Facebook Link"></a>
 ...
 -->  
    ...
    <div class="col-sm-10 d-flex justify-content-around">   
      ...
      <div class="col">
      <i class="fa fa-map-marker" aria-hidden="true"></i><p> 287 Northumberland St, Ayr, ON</p>
      </div>
    </div>
    <div class="col-sm-2 text-center navSocial d-flex justify-content-end">
